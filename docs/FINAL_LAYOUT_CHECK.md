...
Table notes have also been shortened, with methodological detail moved to the main text. Saved-label denominators, participant/window weighting, failure definitions and the one-look tail allocation remain explicit.

Current files: https://github.com/Cyrano666/jrc-reference-emulation/releases/tag/submission-files-2026-09-17-tables
